...
// void getImage(context, noemp,actualiza) {
//   showDialog(
//       context: context,
...
//               InkWell(
//                 onTap: () {
//                   selImage(1, context, noemp,actualiza);   
//                   actualiza();              
//                 },
//                 child: Container(
...
//               InkWell(
//                 onTap: () {
//                   selImage(2, context, noemp,actualiza);
//                   actualiza();              
...
// Future selImage(opc, context, noemp,actualiza) async {
...
// Card miUsuario(context, nombre, puesto, depto, imagen, noemp,actualiza) {
//   return Card(
...
//                       getImage(context, noemp,actualiza);
//                       usuarioProvider!.getUsuario(noemp);
//                       //actualiza();
//                       cambio = true;
